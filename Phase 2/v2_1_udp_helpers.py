#!/usr/bin/env python3
"""
v2_udp_helpers.py - Helper functions for RDT 2.2 implementation
This module provides checksum, packet creation, and packet sending functions.
It supports:
...
def send_packet(packet, server_address, server_port, client_socket, sequence_number,
    ...
    In mode 2, simulates ACK bit-errors with probability = error_rate.
    """
    while True:
